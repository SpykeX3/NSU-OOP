...
public class Notebook {
   ...
   */
  public boolean checkUniq(String title) {
  ...
  private static Options initOpts() {
    ...
    options.addOption(
        ...
        "before",
        true,
        "Filter notes before date to show. Usage -b \"Dec 26, 2019, 10:05:36 PM\"");
    options.addOption(
        "a",
        "after",
        true,
        "Filter notes after date to show. Usage -a \"Dec 26, 2019, 10:05:36 PM\"");
    Option incOpt =
        new Option(
            "i",
            "includes",
